...
function f_vApa1(){
	...
	"processos_na_transformacao1".text = i_a_p_a_t_past.value = "";
}
function f_vApa2(){
	vApa2 = vApa2+1;	
	...
	"processos_na_transformacao2".text = i_a_p_a_t_refri.value = "";
}
function f_vApa3(){
	vApa3 = vApa3+1;
	...
	"processos_na_transformacao3".text = i_a_p_a_t_cong.value = "";
}
function f_vApa4(){
	vApa4 = vApa4+1;
	...
	"processos_na_transformacao4".text = i_a_p_a_t_uflb.value = "";
}
function f_vApa5(){
	vApa5 = vApa5+1;
	...
	"processos_na_transformacao5".text = i_a_p_a_t_defu.value = "";
	}
function f_vApa6(){
	vApa6 = vApa6+1;
	...
	"processos_na_transformacao6".text = i_a_p_a_t_emva.value = "";
	}
...
function f_vAcap4(){
	...
	if(vAcap4%2 == 0){fichap4.controle_processo4=i_a_c_a_p_v_pra.value;}
		"controle_processo4".text = i_a_c_a_p_v_pra.value = "";
}
function f_vAcap5(){
	vAcap5 = vAcap5+1;
	...
	if(vAcap5%2 == 0){fichap4.controle_processo5=i_a_c_a_p_con_mic.value;}
		"controle_processo5".text = i_a_c_a_p_con_mic.value = "";
}
...
function f_qfa_0(){
	...
	if(qfa0%2 == 0){fichap5.QUAL_E_A_FONTE_DE_AGUA1=I_QFA_poco_artesiano.value;}
		"QUAL_E_A_FONTE_DE_AGUA1".text = I_QFA_poco_artesiano.value = "";		
}
function f_qfa_1(){
	qfa1 = qfa1+1;
	...
	if(qfa1%2 == 0){fichap5.QUAL_E_A_FONTE_DE_AGUA2=I_QFA_vertente.value;}
		"QUAL_E_A_FONTE_DE_AGUA2".text = I_QFA_vertente.value = "";
}
function f_qfa_2(){
	qfa2 = qfa2+1;
	...
	if(qfa2%2 == 0){fichap5.QUAL_E_A_FONTE_DE_AGUA3=I_QFA_a_r_publica.value;}
		"QUAL_E_A_FONTE_DE_AGUA3".text = I_QFA_a_r_publica.value = "";
}
function f_qfa_3(){
	qfa3 = qfa3+1;
	...
	if(qfa3 == 0){fichap5.QUAL_E_A_FONTE_DE_AGUA4=I_QFA_poco_comum.value;}
		"QUAL_E_A_FONTE_DE_AGUA4".text = I_QFA_poco_comum.value = "";
}
function f_qfa_4(){
	qfa4 = qfa4+1;
	...
	if(qfa4 == 0){fichap5.QUAL_E_A_FONTE_DE_AGUA5=I_QFA_nascente.value;}	
		"QUAL_E_A_FONTE_DE_AGUA5".text = I_QFA_nascente.value = "";
}
function f_qfa_5(){
	qfa5 = qfa5+1;
	...
	if(qfa5%2 == 0){fichap5.QUAL_E_A_FONTE_DE_AGUA6=I_QFA_outro.value;}	
		"QUAL_E_A_FONTE_DE_AGUA6".text = I_QFA_outro.value = "";
}
...
var	v_cont_mult_p5 = localStorage.getItem("cont_multiplap5");
	...
	if(PQUA1%2 == 0){fichap5.PARA_QUE_UTILIZADA_AGUA1=I_PQUA_MAT_PRIMA.value;}
		"PARA_QUE_UTILIZADA_AGUA1".text = I_PQUA_MAT_PRIMA.value = "";
}
function F_PQUA_2(){
var	v_cont_mult_p5 = localStorage.getItem("cont_multiplap5");
	PQUA2 = PQUA2+1;
	...
	if(PQUA2%2 == 0){fichap5.PARA_QUE_UTILIZADA_AGUA2=I_PQUA_BENEF_PRODUTO.value;}	
		"PARA_QUE_UTILIZADA_AGUA2".text = I_PQUA_BENEF_PRODUTO.value = "";
}
function F_PQUA_3(){
var	v_cont_mult_p5 = localStorage.getItem("cont_multiplap5");
	PQUA3 = PQUA3+1;
	...
	if(PQUA3%2 == 0){fichap5.PARA_QUE_UTILIZADA_AGUA3=I_PQUA_LIM_INSTACOES.value;}	
		"PARA_QUE_UTILIZADA_AGUA3".text = I_PQUA_LIM_INSTACOES.value = "";
}
/*PARA QUE E UTILIZADA A ÁGUA*/
/* fim ambiental*/
