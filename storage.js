...
function mofamilhar(fmofamilhar)
{
	...
	if(fmofamilhar == 2){
		localStorage.setItem("mao_de_obra_familhar", i_f_n.value);
	}
}
...
function org_asso_cap_tec (forg_asso_cap_tec)
{
	...
	localStorage.setItem("organizacao_associacao_captacao_tecnologia",i_orcap__s.value);
	}
	if(forg_asso_cap_tec == 2){
	localStorage.setItem("organizacao_associacao_captacao_tecnologia",i_orcap_n.value);
	}
}
...
function org_asso_assis_tec(forg_asso_assis_tec)
{
	...
	{
	localStorage.setItem("organizacao_associacao_assitencia_tecnica",i_orassi_s.value);
	}
	if(forg_asso_assis_tec == 2)
	{
	localStorage.setItem("organizacao_associacao_assitencia_tecnica",i_orassi_n.value);
	}
}
