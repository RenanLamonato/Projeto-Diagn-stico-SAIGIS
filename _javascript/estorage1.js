...
var v_cont_p1;
	...
	if (v_cont_p1 == null){
	  ...
	  if(typeof (fichap1.categoria) === "undefined")     // se categoria não foi preenchida por f_1_2() então
        fichap1.categoria = " ";                                            // coloca só um espaço para ela 	
...
var v_cont_p2;
	...
	if (v_cont_p2 == null){
	 ...
	 if(typeof (fichap2.agroindustria) === "undefined") 
        fichap2.agroindustria = " ";   
	 if(typeof (fichap2.se_individual) === "undefined") 
        fichap2.se_individual = " ";   
	 if(typeof (fichap2.se_coletiva) === "undefined") 
        fichap2.se_coletiva = " ";   
	 if(typeof (fichap2.Localizacao) === "undefined") 
        fichap2.Localizacao = " ";   
	 if(typeof (fichap2.Instalacao) === "undefined") 
        fichap2.Instalacao = " ";   
	 if(typeof (fichap2.area_construida) === "undefined") 
        fichap2.area_construida = " ";   
	 if(typeof (fichap2.banheiros_adequados_inspeção) === "undefined") 
        fichap2.banheiros_adequados_inspeção = " ";   
	 if(typeof (fichap2.possui_dependencias_exclusiva_para_producao) === "undefined") 
        fichap2.possui_dependencias_exclusiva_para_producao = " ";   
	 if(typeof (fichap2.Exclusiva_familiar) === "undefined") 
        fichap2.Exclusiva_familiar = " ";   	
	 if(typeof (fichap2.faixa_etaria_homens) === "undefined") 
        fichap2.faixa_etaria_homens = " ";
	 if(typeof (fichap2.faixa_etaria_mulheres) === "undefined") 
        fichap2.faixa_etaria_mulheres = " ";
	 if(typeof (fichap2.renda_media_familia) === "undefined") 
        fichap2.renda_media_familia = " ";
	 if(typeof (fichap2.Grau_importancia_ativ_renda_prop_e_da_familia) === "undefined") 
        fichap2.Grau_importancia_ativ_renda_prop_e_da_familia = " ";
	 if(typeof (fichap2.mao_de_obra_contratada) === "undefined") 
        fichap2.mao_de_obra_contratada = " ";
	 if(typeof (fichap2.Procedencia) === "undefined") 
        fichap2.Procedencia = " ";
...
var v_cont_p6;
	...
	if(typeof (fichap6.Total_investido_na_agroindustria) === "undefined") 
    fichap6.Total_investido_na_agroindustria = " ";   
	if(typeof (fichap6.proprio) === "undefined") 
    fichap6.proprio = " ";   
	if(typeof (fichap6.terceiros_financiado) === "undefined") 
    fichap6.terceiros_financiado = " ";   
	if(typeof (fichap6.pretende_investir) === "undefined") 
    fichap6.pretende_investir = " ";   
	if(typeof (fichap6.em_qual_area) === "undefined") 
    fichap6.em_qual_area = " ";   
	if(typeof (fichap6.Capacitação_cursos_treinamentos) === "undefined") 
    fichap6.Capacitação_cursos_treinamentos = " ";   
	if(typeof (fichap6.assistencia_tecnica) === "undefined") 
    fichap6.assistencia_tecnica = " ";   
	if(typeof (fichap6.Projeto_adequação_ampliação_Equipamentos) === "undefined") 
    fichap6.Projeto_adequação_ampliação_Equipamentos = " ";   
	if(typeof (fichap6.comercializacao) === "undefined") 
    fichap6.comercializacao = " ";   
	if(typeof (fichap6.credito) === "undefined") 
    fichap6.credito = " ";   
	if(typeof (fichap6.necessidade_mao_de_obra) === "undefined") 
    fichap6.necessidade_mao_de_obra = " ";   

	fichap6.assistencia_tecnica_qual=chekbox3;
...
function f_10_2_11(){
	vas_tec1 = vas_tec1+1;
	if(vas_tec1%2 == 1){chekbox3.assistencia_tecnica_qual_1=i_at_tec.value;}
	if(vas_tec1%2 == 0){chekbox3.assistencia_tecnica_qual_1=i_at_tec.value;}
}
function f_10_2_12(){
	vas_tec2 = vas_tec2+1;
	if(vas_tec2%2 == 1){chekbox3.assistencia_tecnica_qual_2=i_at_cont_qual.value;}
	if(vas_tec2%2 == 0){chekbox3.assistencia_tecnica_qual_2=i_at_cont_qual.value;}
}
function f_10_2_13(){
	vas_tec3 = vas_tec3+1;
	if(vas_tec3%2 == 1){chekbox3.assistencia_tecnica_qual_3=i_at_merc_mark.value;}
	if(vas_tec3%2 == 0){chekbox3.assistencia_tecnica_qual_3=i_at_merc_mark.value;}
}
function f_10_2_14(){
	vas_tec4 = vas_tec4+1;
	if(vas_tec4%2 == 1){chekbox3.assistencia_tecnica_qual_4=i_at_cont_fina.value;}
	if(vas_tec4%2 == 0){chekbox3.assistencia_tecnica_qual_4=i_at_cont_fina.value;}
}
...
function comercicializacao_regumalentacao()
{
	...
	if(typeof (fichap3.Faturamento_médio_mensal_da_agroindustria) === "undefined") 
    fichap6.Faturamento_médio_mensal_da_agroindustria = " ";   
	if(typeof (fichap3.Grau_prioridade_renda_relação_propriedade) === "undefined") 
    fichap6.Grau_prioridade_renda_relação_propriedade = " ";   
	if(typeof (fichap3.local_de_venda) === "undefined") 
    fichap6.local_de_venda = " ";   
	if(typeof (fichap3.Regularização_sanitária_inspeção_sanitária_produto_animal) === "undefined") 
    fichap6.Regularização_sanitária_inspeção_sanitária_produto_animal = " ";   
	if(typeof (fichap3.Regularização_sanitária_origem_vegetal) === "undefined") 
    fichap6.Regularização_sanitária_origem_vegetal = " ";   
	if(typeof (fichap3.Rotulagem) === "undefined") 
    fichap6.Rotulagem = " ";   
	if(typeof (fichap3.Regularização_ambiental) === "undefined") 
    fichap6.Regularização_ambiental = " ";   
...
function f_tecnologia_assistencia()
{
	...
	v_cont_p4 = localStorage.getItem("contp4");
		...
		if(typeof (fichap4.Nível_de_tecnologia_de_produção_aplicada) === "undefined") 
		fichap4.Nível_de_tecnologia_de_produção_aplicada = " ";
		if(typeof (fichap4.Possui_assistência_técnica_frequente) === "undefined") 
		fichap4.Possui_assistência_técnica_frequente = " ";  
		if(typeof (fichap4.se_sim_qual_frequencia_atendimento) === "undefined") 
		fichap4.se_sim_qual_frequencia_atendimento = " "; 

	
	fichap4.processos_transformação = chekbox;
	fichap4.controle_processo = chekbox2;
...
function f_vApa1(){
	vApa1 = vApa1+1;
	if(vApa1%2 == 1){chekbox.processos_na_transformacao1=i_a_p_a_t_past.value;}	
	if(vApa1%2 == 0){chekbox.processos_na_transformacao1=i_a_p_a_t_past.value;}	
	"processos_na_transformacao1".checkbox = i_a_p_a_t_past.value = "";
}
function f_vApa2(){
	vApa2 = vApa2+1;	
	if(vApa2%2 == 1){chekbox.processos_na_transformacao2=i_a_p_a_t_refri.value;}
	if(vApa2%2 == 0){chekbox.processos_na_transformacao2=i_a_p_a_t_refri.value;}
	"processos_na_transformacao2".checkbox = i_a_p_a_t_refri.value = "";
}
function f_vApa3(){
	vApa3 = vApa3+1;
	if(vApa3%2 == 1){chekbox.processos_na_transformacao3=i_a_p_a_t_cong.value;}
	if(vApa3%2 == 0){chekbox.processos_na_transformacao3=i_a_p_a_t_cong.value;}
	"processos_na_transformacao3".checkbox = i_a_p_a_t_cong.value = "";
}
function f_vApa4(){
	vApa4 = vApa4+1;
	if(vApa4%2 == 1){chekbox.processos_na_transformacao4=i_a_p_a_t_uflb.value;}
	if(vApa4%2 == 0){chekbox.processos_na_transformacao4=i_a_p_a_t_uflb.value;}
	"processos_na_transformacao4".checkbox = i_a_p_a_t_uflb.value = "";
}
function f_vApa5(){
	vApa5 = vApa5+1;
	if(vApa5%2 == 1){chekbox.processos_na_transformacao5=i_a_p_a_t_defu.value;}
	if(vApa5%2 == 0){chekbox.processos_na_transformacao5=i_a_p_a_t_defu.value;}
	"processos_na_transformacao5".checkbox = i_a_p_a_t_defu.value = "";
	}
function f_vApa6(){
	vApa6 = vApa6+1;
	if(vApa6%2 == 1){chekbox.processos_na_transformacao6=i_a_p_a_t_emva.value;}
	if(vApa6%2 == 0){chekbox.processos_na_transformacao6=i_a_p_a_t_emva.value;}
...
function f_vAcap1(){
	vAcap1 = vAcap1+1;
	if(vAcap1%2 == 1){chekbox2.controle_processo1=i_a_c_a_p_camp.value;}
	if(vAcap1%2 == 0){chekbox2.controle_processo1=i_a_c_a_p_camp.value;}
		"controle_processo1".checkbox = i_a_c_a_p_camp.value = "";
}
function f_vAcap2(){
	vAcap2 = vAcap2+1;
	if(vAcap2%2 == 1){chekbox2.controle_processo2=i_a_c_a_p_BPF.value;}
	if(vAcap2%2 == 0){chekbox2.controle_processo2=i_a_c_a_p_BPF.value;}
		"controle_processo2".checkbox = i_a_c_a_p_BPF.value = "";
}
function f_vAcap3(){
	vAcap3 = vAcap3+1;
	if(vAcap3%2 == 1){chekbox2.controle_processo3=i_a_c_a_p_reg.value;}
	if(vAcap3%2 == 0){chekbox2.controle_processo3=i_a_c_a_p_reg.value;}
		"controle_processo3".checkbox = i_a_c_a_p_reg.value = "";
}
function f_vAcap4(){
	vAcap4 = vAcap4+1;
	if(vAcap4%2 == 1){chekbox2.controle_processo4=i_a_c_a_p_v_pra.value;}
	if(vAcap4%2 == 0){chekbox2.controle_processo4=i_a_c_a_p_v_pra.value;}
		"controle_processo4".checkbox = i_a_c_a_p_v_pra.value = "";
}
function f_vAcap5(){
	vAcap5 = vAcap5+1;
	if(vAcap5%2 == 1){chekbox2.controle_processo5=i_a_c_a_p_con_mic.value;}
	if(vAcap5%2 == 0){chekbox2.controle_processo5=i_a_c_a_p_con_mic.value;}
...
var v_cont_p5;
	...
	if(typeof (fichap5.realiza_algum_tratamento_de_agua_antes_da_utilizacao) === "undefined") 
	fichap5.realiza_algum_tratamento_de_agua_antes_da_utilizacao = " ";
	if(typeof (fichap5.SE_ENQUADRA_NA_LEGISLAÇÃO_AMBIENTAL) === "undefined") 
	fichap5.SE_ENQUADRA_NA_LEGISLAÇÃO_AMBIENTAL = " ";
	if(typeof (fichap5.agua_usada_na_materia_prima) === "undefined") 
	fichap5.agua_usada_na_materia_prima = " ";
	if(typeof (fichap5.agua_usada_no_benificiamento_produtos) === "undefined") 
	fichap5.agua_usada_no_benificiamento_produtos = " ";
	if(typeof (fichap5.fracao_da_agua_usada_na_limpeza_instalacoes) === "undefined") 
	fichap5.fracao_da_agua_usada_na_limpeza_instalacoes = " ";
	if(typeof (fichap5.REALIZADO_TRAT_AGUA_ANTES_UTIL) === "undefined") 
	fichap5.REALIZADO_TRAT_AGUA_ANTES_UTIL = " ";
	if(typeof (fichap5.EXISTENCIA_SISTEMA_TRATAMENTO_EFICIENCIA) === "undefined") 
	fichap5.EXISTENCIA_SISTEMA_TRATAMENTO_EFICIENCIA = " ";
	if(typeof (fichap5.REALIZA_REAPROVEITAM_PROC_PRODUTIVO) === "undefined") 
	fichap5.REALIZA_REAPROVEITAM_PROC_PRODUTIVO = " ";
...
function enviar(){
  ...
  armazenamento_local_json = JSON.stringify(localStorage);  // passar o armazenamento local para formato json
    ...
    xhr.open("POST", "https://script.google.com/a/alunos.utfpr.edu.br/macros/s/AKfycbyvPCrrhz4ft7fvwFLsqr9nbJU1zP8PbxCgXboeMfm1ibU_DFVv/exec", true);
